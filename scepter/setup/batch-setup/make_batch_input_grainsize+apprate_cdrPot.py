...
dustrate_ton_ha_yr = [
    np.round((1 / fs_pots[dustsp]) * x, 4) for x in dustrate_ton_ha_yr_CO2pot
]
all_combinations = {
    ...
    "dustrad": [
        ...
        150,
        200,
    ],  # [diameter, microns] i think this gets applied to gbas and amnt equally (though amnt is fast-reacting so maybe not a big deal? )
}
